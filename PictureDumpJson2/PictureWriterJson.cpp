...
void PictureWriterJson::WriteColorSpace(color_space val)
{
#define ENUM_CASE(name) case name: fWr.String(#name); break;
	switch (val) {
							...
							const void* data, int32 length)
{
	...
	fWr.Key("colorSpace"); WriteColorSpace((color_space)colorSpace);
