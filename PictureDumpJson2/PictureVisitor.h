...
public:
	...
	virtual void SetLineMode(cap_mode cap, join_mode join, float miterLimit) {}
	...
	virtual void SetBlendingMode(source_alpha srcAlpha, alpha_function alphaFunc) {}
	...
	// Draw
	virtual void DrawString(const char* string, int32 length, const escapement_delta& delta) {}
	virtual void DrawString(const char* string, int32 length, const BPoint* locations, int32 locationCount) {}
